...
class EEMD:
    ...
    **Ensemble Empirical Mode Decomposition**
    ...
    def generate_noise(self, scale, size):
        ...
        * *uniform* with range [-scale/2, scale/2].
        ...
        if self.noise_kind == "normal":
            ...
            raise ValueError("Unsupported noise kind. Please assigned `noise_kind` to be one of these: {}"
                             .format(self.noise_kinds_all))
    ...
    def emd(self, S, T, max_imf=-1):
        ...
        For reference please see :class:`EMD.EMD`.
        """
